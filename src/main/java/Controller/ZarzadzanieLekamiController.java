...
public class ZarzadzanieLekamiController {
	private static ZarzadzanieLekamiController INSTANCE = null;

	public ZarzadzanieLekamiController() {
	}

	public static ZarzadzanieLekamiController getInstance() {
		if (INSTANCE == null)
			synchronized (ZarzadzanieLekamiController.class) {
				if (INSTANCE == null) {
					INSTANCE = new ZarzadzanieLekamiController();
				}
			}
		return INSTANCE;
	}
