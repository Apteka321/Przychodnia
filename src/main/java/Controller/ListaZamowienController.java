...
public class ListaZamowienController implements Initializable {
	...
	private void usunZaznaczoneZamowienia(ActionEvent event) {
		...
		for (PozycjaZamowienia zamowienieDoUsuniecia : listaZamowienDoUsuniecia) {
			...
			listaProduktowZamowieniawedlugId = zamowienieImpl
					.pobierzProduktZamowienia(zamowienieDoUsuniecia.getIdZamowienia());
	...
	public class PozycjaZamowienia {
		...
		public String toString() {
			return "PozycjaZamowienia{" + "idZamowienia=" + idZamowienia + ", nrSali=" + nrSali + ", dataZamowienia="
					+ dataZamowienia + ", godzinaZamowienia=" + godzinaZamowienia + ", Zleceniodawca=" + Zleceniodawca
					+ ", Status=" + Status + ", zaznaczonyZamowienie=" + zaznaczonyZamowienie + '}';
		}
		...
		public boolean equals(Object obj) {
			...
			if ((this.Zleceniodawca == null) ? (other.Zleceniodawca != null)
					: !this.Zleceniodawca.equals(other.Zleceniodawca)) {
				return false;
			}
			...
			if (this.idZamowienia != other.idZamowienia
					&& (this.idZamowienia == null || !this.idZamowienia.equals(other.idZamowienia))) {
				return false;
			}
			if (this.nrSali != other.nrSali && (this.nrSali == null || !this.nrSali.equals(other.nrSali))) {
				return false;
			}
			if (this.dataZamowienia != other.dataZamowienia
					&& (this.dataZamowienia == null || !this.dataZamowienia.equals(other.dataZamowienia))) {
				return false;
			}
			if (this.godzinaZamowienia != other.godzinaZamowienia
					&& (this.godzinaZamowienia == null || !this.godzinaZamowienia.equals(other.godzinaZamowienia))) {
				return false;
			}
			if (this.zaznaczonyZamowienie != other.zaznaczonyZamowienie && (this.zaznaczonyZamowienie == null
					|| !this.zaznaczonyZamowienie.equals(other.zaznaczonyZamowienie))) {
				return false;
			}
			return true;
		}
		...
		public PozycjaZamowienia(Integer idZamowienia, Integer nrSali, Date dataZamowienia, Time godzinaZamowienia,
				String Zleceniodawca, String Status, CheckBox zaznaczonyZamowienie) {
			this.idZamowienia = idZamowienia;
			this.nrSali = nrSali;
			this.dataZamowienia = dataZamowienia;
			this.godzinaZamowienia = godzinaZamowienia;
